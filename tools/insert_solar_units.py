...
def insert_row(cur, row):
    columns = [
        ...
        'network_operator_status', 'operator_registration_number', 'country',
        'state', 'district', 'municipality', 'municipality_key', 'postcode', 'city',
        'registration_date', 'commissioning_date', 'system_status', 'operational_status',
        'not_present_migrated_units', 'power_unit_name', 'weic_nv', 'power_plant_number_nv',
        'energy_source', 'gross_power', 'net_rated_power', 'remote_controllability',
        'type_feed_in', 'assigned_active_power_inverter', 'amount_modules', 'location',
        'power_limitation', 'uniform_orientation_tilt_angle', 'main_orientation',
        'main_orientation_tilt_angle', 'usage_area', 'eeg_registration_number'
    ]
...
def read_solar_units(conn, src):
    ...
    for event, elem in context:
        unit = {
            ...
            'municipality': parse_value(elem, 'Gemeinde'),
            ...
            'weic_nv': parse_value(elem, 'Weic_nv'),
            'power_plant_number_nv': parse_value(elem, 'Kraftwerksnummer_nv'),
            ...
            'type_feed_in': parse_value(elem, 'Einspeisungsart'),
